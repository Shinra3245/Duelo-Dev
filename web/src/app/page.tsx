...
export default function Home() {
  ...
  return (
    <main
      ref={landingRef}
      className={`${displayFont.variable} duel-landing relative min-h-screen overflow-hidden bg-slate-950 px-4 py-6 text-slate-100 sm:px-6 sm:py-10 lg:px-10`}
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto grid w-full max-w-6xl gap-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-stretch">
        <section className="flex flex-col justify-between rounded-3xl border border-white/10 bg-white/[0.07] p-6 shadow-2xl shadow-black/20 backdrop-blur sm:p-10">
          ...
          <div>
            ...
            <ol data-landing-item className="mt-8 space-y-4 text-base text-slate-200">
          ...
          <div data-landing-item className="mt-10 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-emerald-300/20 bg-emerald-300/10 p-4 transition-transform duration-200 motion-safe:hover:-translate-y-1">
              ...
              <p className="mt-1 text-base leading-6 text-emerald-100/80">
            ...
            <div className="rounded-2xl border border-indigo-300/20 bg-indigo-300/10 p-4 transition-transform duration-200 motion-safe:hover:-translate-y-1">
              ...
              <p className="mt-1 text-base leading-6 text-indigo-100/80">
        ...
        >
          <div className="mb-7">
            ...
            <p className="player-access-copy mt-2 text-base leading-6 text-slate-600">
          ...
          {loadError && (
            <div
              className="player-access-alert mb-4 rounded border border-amber-200 bg-amber-50 p-3 text-base text-amber-900"
              role="alert"
            >
              {loadError}
            </div>
          ...
          {error && (
            <div
              className="player-access-alert mb-5 rounded-2xl border border-rose-200 bg-rose-50 p-4 text-base font-medium leading-6 text-rose-800"
              role="alert"
              aria-live="polite"
            >
              {error}
          ...
          {loading ? (
              ...
              <form onSubmit={handleAccess} className="player-access-form space-y-5">
                ...
                {accessMode !== 'login' && (
                  <div>
                    ...
                    />
                    <p className="player-access-help mt-2 text-base leading-6 text-slate-500">
                ...
                <p className="player-access-note rounded-2xl border border-indigo-100 bg-indigo-50 p-3 text-base leading-6 text-indigo-900">
                  {accessMode === 'register'
            ...
            <div className="space-y-6">
              ...
              {user.role === 'guest' && (
                <p className="player-access-note rounded-2xl border border-amber-200 bg-amber-50 p-3 text-base leading-6 text-amber-950">
      ...
      <section className="landing-showcase" aria-labelledby="showcase-title">
        ...
        <div data-scroll-reveal className="landing-final-cta">
          <div>
            <p className="landing-section-kicker">¿LISTO PARA TU PRIMER DUELO?</p>
